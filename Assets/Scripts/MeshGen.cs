...
public class MeshGen : MonoBehaviour
{
    ...
    public Mesh CreateWallMesh(float wallh = 1)
    {
        ...
        //reversing normals inverts the directions the mesh is displayed, reversing them here means that the walls are drawn facing inwards.
        ...
        int[] triangles = wallMesh.GetTriangles(0);
        ...
        public SquareGrid(bool[,] map, float squareSize)
        {
            ...
            for (int x = 0; x < nodeCountX; x++)
            {
                for (int y = 0; y < nodeCountY; y++)
                {
                    ...
                    controlNodes[x, y] = new ControlNode(pos, map[x, y] == false, squareSize);
                }
            }
